async function calculate() {
  ...
  switch (operator) {
    case "+":
      ...
      try {
        await fetch(`/lab3/add?num1=${num1}&num2=${num2}`)
    ...
    case "-":
      ...
      try {
        await fetch(`/lab3/subtract?num1=${num1}&num2=${num2}`)
          .then((response) => response.json())
          .then((data) => {
            console.log(data);
    ...
    case "*":
      ...
      try {
        await fetch(`/lab3/multiply?num1=${num1}&num2=${num2}`)
          .then((response) => response.json())
          .then((data) => {
            console.log(data);
    ...
    case "/":
      ...
      try {
        await fetch(`/lab3/divide?num1=${num1}&num2=${num2}`)
          .then((response) => response.json())
          .then((data) => {
